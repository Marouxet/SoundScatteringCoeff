...
[~ , a]= max(energia_impulso);
energia_impulso = energia_impulso(a:end);
...
%Guardo el valor de ruido para usarlo luego en el cálculo de TR
rms_dB_ruido = rms_dB;
save('app_data/current.mat','-v6','rms_dB_ruido','-append');
clear rms_dB_ruido
