function ir = AnalyseMLSSequence(signal,orden,reps)
...
[~,mls,N] = GenerateMLS(orden,1,0); %Genero la secuencia usada originalmente y adem�s obtengo el orden de la misma.
